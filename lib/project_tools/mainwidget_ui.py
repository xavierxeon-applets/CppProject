...
class Ui_MainWidget(object):
    def setupUi(self, MainWidget):
        ...
        self.gridLayout.addWidget(self.typeGroup, 0, 0, 1, 1)
        ...
        self.logEdit = QTextEdit(self.operationGroup)
        ...
        self.gridLayout.addWidget(self.operationGroup, 0, 1, 5, 1)
        ...
        self.gridLayout.addWidget(self.targetGroup, 1, 0, 1, 1)
        ...
        self.gridLayout.addWidget(self.componentGroup, 2, 0, 1, 1)
        ...
        self.gridLayout.addWidget(self.featureGroup, 3, 0, 1, 1)
